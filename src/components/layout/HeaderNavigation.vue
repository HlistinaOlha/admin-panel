          ...
          <ul class="submenu">
            <li class="nav-item">
              <router-link class="nav-link" to="/commands">
                <span class="material-symbols-outlined menu-icon">imagesmode</span>
                <span class="category-heading menu-title">Image commands</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/holidays">
                <span class="material-symbols-outlined menu-icon">beach_access</span>
                <span class="category-heading menu-title">Holidays</span>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/leagues">
                <span class="material-symbols-outlined menu-icon">sports_soccer</span>
                <span class="category-heading menu-title">Leagues</span>
              </router-link>
            </li>
